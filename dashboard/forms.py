...
class StudentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'driving_license': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. Type B'}),
            'license_pass_year': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Year & Month'}),
            'license_type_2': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. Type A'}),
